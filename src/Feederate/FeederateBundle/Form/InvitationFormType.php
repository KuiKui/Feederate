...
use Feederate\FeederateBundle\Form\DataTransformer\InvitationToCodeTransformer;
...
class InvitationFormType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'class'    => 'Feederate\FeederateBundle\Entity\Invitation',
            'required' => true,
        ));
    }
    ...
    {
        return 'feederate_invitation_type';
    }
}
